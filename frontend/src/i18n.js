...
const messages = {
  zh: {
    ...
    token: {
      ...
      efficiency: '效率指标',
      costPrediction: '成本预测',
      monthlyEstimate: '月度预计',
      dailyAvg: '日均消耗',
      trend_up: '上升趋势',
      trend_down: '下降趋势',
      trend_stable: '保持稳定',
      periodComparison: '时段对比',
      currentPeriod: '当前时段',
      previousPeriod: '上个时段',
      changePercent: '变化百分比',
      topSessions: '对话排行 Top10',
      sessionId: '对话ID',
      heatmap: 'Token 热力日历',
      modelPreference: '模型偏好分布',
      exportData: '导出数据',
      budget: '预算管理',
      monthlyBudget: '月度预算',
      currentSpent: '已消耗',
      ...
      avgRatio: '平均比率',
      perDollar: '每美元产出',
      demoNotice: '当前展示的是演示数据，非真实 Token 日志'
    },
    weather: {
      current: '当前天气',
      forecast: '近一周天气',
  ...
  en: {
    ...
    token: {
      ...
      demoNotice: 'Showing demo data — not from real token logs'
    },
    weather: {
